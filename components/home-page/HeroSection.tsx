...
export function HeroSection() {
  ...
  return (
    <section className="relative h-[600px] overflow-hidden rounded-b-3xl shadow-xl w-full">
        ...
        <div className="max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4">
            <Button asChild size="lg" className="bg-white text-primary hover:bg-white/90">
              <Link href="/ofertas-laborales">Ver ofertas laborales</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-white text-neutral-800 hover:bg-white/10">
              <Link href="/empleos/nueva">Publicar empleo</Link>
            </Button>
          </div>
        </div>
      </div>
